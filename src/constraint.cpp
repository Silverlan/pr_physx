...
pragma::physics::PhysXConstraint &pragma::physics::PhysXConstraint::GetConstraint(IConstraint &c) { return *static_cast<PhysXConstraint *>(c.GetUserData()); }
...
pragma::physics::PhysXConstraint::PhysXConstraint(IEnvironment &env, PhysXUniquePtr<physx::PxJoint> joint) : IConstraint {env}, m_joint {std::move(joint)} { SetUserData(this); }
...
void pragma::physics::PhysXConstraint::DoSetCollisionsEnabled(Bool b) { GetInternalObject().setConstraintFlag(physx::PxConstraintFlag::eCOLLISION_ENABLED, b); }
...
bool pragma::physics::PhysXConstraint::IsEnabled() const { return umath::is_flag_set(m_stateFlags, StateFlags::Enabled); }
...
bool pragma::physics::PhysXConstraint::IsBroken() const { return umath::is_flag_set(m_stateFlags, StateFlags::Broken); }
...
pragma::physics::PhysXFixedConstraint::PhysXFixedConstraint(IEnvironment &env, PhysXUniquePtr<physx::PxJoint> c) : IFixedConstraint {env}, PhysXConstraint {env, std::move(c)}, IConstraint {env} {}

/////////////

pragma::physics::PhysXBallSocketConstraint::PhysXBallSocketConstraint(IEnvironment &env, PhysXUniquePtr<physx::PxJoint> c) : IBallSocketConstraint {env}, PhysXConstraint {env, std::move(c)}, IConstraint {env} {}

/////////////

pragma::physics::PhysXHingeConstraint::PhysXHingeConstraint(IEnvironment &env, PhysXUniquePtr<physx::PxJoint> c) : IHingeConstraint {env}, PhysXConstraint {env, std::move(c)}, IConstraint {env}
{
...
std::pair<umath::Radian, umath::Radian> pragma::physics::PhysXHingeConstraint::GetLimit() const { return {m_lowerLimit, m_upperLimit}; }
...
void pragma::physics::PhysXHingeConstraint::DisableLimit() { GetInternalObject().setRevoluteJointFlag(physx::PxRevoluteJointFlag::eLIMIT_ENABLED, false); }
float pragma::physics::PhysXHingeConstraint::GetSoftness() const { return m_softness; }
float pragma::physics::PhysXHingeConstraint::GetDamping() const { return m_damping; }
...
pragma::physics::PhysXSliderConstraint::PhysXSliderConstraint(IEnvironment &env, PhysXUniquePtr<physx::PxJoint> c) : ISliderConstraint {env}, PhysXConstraint {env, std::move(c)}, IConstraint {env}
{
	auto limit = GetInternalObject().getLimit();
	m_softness = limit.stiffness;
	m_damping = limit.damping;
...
void pragma::physics::PhysXSliderConstraint::DisableLimit() { GetInternalObject().setPrismaticJointFlag(physx::PxPrismaticJointFlag::eLIMIT_ENABLED, false); }
...
std::pair<float, float> pragma::physics::PhysXSliderConstraint::GetLimit() const { return {GetPxEnv().FromPhysXLength(GetInternalObject().getLimit().lower), GetPxEnv().FromPhysXLength(GetInternalObject().getLimit().upper)}; }
...
pragma::physics::PhysXConeTwistConstraint::PhysXConeTwistConstraint(IEnvironment &env, PhysXUniquePtr<physx::PxJoint> c, const physx::PxTransform &pose0, const physx::PxTransform &pose1)
    : IConeTwistConstraint {env}, PhysXConstraint {env, std::move(c)}, IConstraint {env}, m_localPoses {pose0, pose1}
{
...
{
	auto centerLimits = Vector2 {(m_lowerLimits.x + m_upperLimits.x) / 2.f, (m_lowerLimits.y + m_upperLimits.y) / 2.f};
...
{
	Vector2 swingSpan = {m_upperLimits.x - m_lowerLimits.x, m_upperLimits.y - m_lowerLimits.y};
...
pragma::physics::PhysXDoFConstraint::PhysXDoFConstraint(IEnvironment &env, PhysXUniquePtr<physx::PxJoint> c) : IDoFConstraint {env}, PhysXConstraint {env, std::move(c)}, IConstraint {env} {}
...
pragma::physics::PhysXDoFSpringConstraint::PhysXDoFSpringConstraint(IEnvironment &env, PhysXUniquePtr<physx::PxJoint> c) : IDoFSpringConstraint {env}, PhysXConstraint {env, std::move(c)}, IConstraint {env} {}
