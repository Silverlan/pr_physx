...
pragma::physics::PhysXMaterial &pragma::physics::PhysXMaterial::GetMaterial(IMaterial &o) { return *static_cast<PhysXMaterial *>(o.GetUserData()); }
...
pragma::physics::PhysXMaterial::PhysXMaterial(IEnvironment &env, PhysXUniquePtr<physx::PxMaterial> material) : IMaterial {env}, m_material {std::move(material)} { SetUserData(this); }
