...
pragma::physics::PhysXCollisionObject *pragma::physics::PhysXEnvironment::GetCollisionObject(const physx::PxRigidActor &actor)
{
	return static_cast<pragma::physics::PhysXCollisionObject*>(actor.userData);
}
pragma::physics::PhysXConstraint *pragma::physics::PhysXEnvironment::GetConstraint(const physx::PxJoint &constraint)
{
...
{
	return static_cast<pragma::physics::PhysXController*>(controller.getUserData());
}
pragma::physics::PhysXMaterial *pragma::physics::PhysXEnvironment::GetMaterial(const physx::PxMaterial &material)
{
	return static_cast<pragma::physics::PhysXMaterial*>(material.userData);
}
...
physx::PxVec3 pragma::physics::PhysXEnvironment::ToPhysXVector(const Vector3 &v) const
{
	return physx::PxVec3{v.x,v.y,v.z};
}
physx::PxExtendedVec3 pragma::physics::PhysXEnvironment::ToPhysXExtendedVector(const Vector3 &v) const
{
	return physx::PxExtendedVec3{v.x,v.y,v.z};
}
Vector3 pragma::physics::PhysXEnvironment::FromPhysXVector(const physx::PxExtendedVec3 &v) const
{
	return Vector3{static_cast<float>(v.x),static_cast<float>(v.y),static_cast<float>(v.z)};
}
physx::PxVec3 pragma::physics::PhysXEnvironment::ToPhysXNormal(const Vector3 &n) const
{
	return physx::PxVec3{n.x,n.y,n.z};
}
physx::PxVec3 pragma::physics::PhysXEnvironment::ToPhysXTorque(const Vector3 &t) const
{
...
Vector3 pragma::physics::PhysXEnvironment::FromPhysXVector(const physx::PxVec3 &v) const
{
	return Vector3{v.x,v.y,v.z};
}
Vector3 pragma::physics::PhysXEnvironment::FromPhysXNormal(const physx::PxVec3 &n) const
{
	return Vector3{n.x,n.y,n.z};
}
Vector3 pragma::physics::PhysXEnvironment::FromPhysXTorque(const physx::PxVec3 &t) const
{
