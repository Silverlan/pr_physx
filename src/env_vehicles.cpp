...
#ifdef ENABLE_PX_VEHICLES
pragma::physics::VehicleSceneQueryData::VehicleSceneQueryData(uint32_t numQueriesInBatch) : m_batchQueryDesc {numQueriesInBatch, numQueriesInBatch, 0} {}
...
static void customizeVehicleToLengthScale(physx::PxReal lengthScale, physx::PxRigidDynamic &rigidDynamic, physx::PxVehicleWheelsSimData &wheelsSimData, physx::PxVehicleDriveSimData &driveSimData)
{
...
static void customizeVehicleToLengthScale(physx::PxReal lengthScale, physx::PxRigidDynamic &rigidDynamic, physx::PxVehicleWheelsSimData &wheelsSimData, physx::PxVehicleDriveSimData4W &driveSimData)
{
...
static util::TSharedHandle<pragma::physics::PhysXRigidBody> createVehicleActor(const physx::PxVehicleChassisData &chassisData, const pragma::physics::VehicleCreateInfo &vhcDesc)
{
...
static void setupWheelsSimulationData(pragma::physics::PhysXEnvironment &env, const pragma::physics::VehicleCreateInfo &vhcCreateInfo, const physx::PxVec3 &chassisCMOffset, const physx::PxF32 chassisMass, physx::PxVehicleWheelsSimData &outWheelsSimData,
  pragma::physics::NoCollisionCategoryId colCategory)
{
	...
	physx::PxVehicleComputeSprungMasses(vhcCreateInfo.wheels.size(), wheelCenterActorOffsets.data(), chassisCMOffset, chassisMass, 1 /* gravity direction relative to chassis */, suspSprungMasses.data());
...
static pragma::physics::PhysXUniquePtr<physx::PxVehicleDrive> createVehicle4W(pragma::physics::PhysXEnvironment &env, const pragma::physics::VehicleCreateInfo &vhcCreateInfo, util::TSharedHandle<pragma::physics::PhysXRigidBody> &outRigidBody,
  pragma::physics::NoCollisionCategoryId colCategory)
{
	...
	std::unique_ptr<physx::PxVehicleWheelsSimData, void (*)(physx::PxVehicleWheelsSimData *)> wheelsSimData {physx::PxVehicleWheelsSimData::allocate(numWheels), [](physx::PxVehicleWheelsSimData *simData) { simData->free(); }};
	...
	setupWheelsSimulationData(env, vhcCreateInfo, cmOffset, mass, *wheelsSimData, colCategory);
	...
	physx::PxVehicleDriveSimData4W driveSimData;
	{
		...
		ackermann.mAxleSeparation = wheelsSimData->getWheelCentreOffset(physx::PxVehicleDrive4WWheelOrder::eFRONT_LEFT).z - wheelsSimData->getWheelCentreOffset(physx::PxVehicleDrive4WWheelOrder::eREAR_LEFT).z;
...
util::TSharedHandle<pragma::physics::IVehicle> pragma::physics::PhysXEnvironment::CreateVehicle(const VehicleCreateInfo &vhcDesc)
{
	...
	static std::array<physx::PxF32, 2 * 4> steerVsForwardSpeedData = {0.0f, 0.75f, 5.0f, 0.75f, 30.0f, 0.125f, 120.0f, 0.1f};
	...
	auto vhc = CreateSharedHandle<PhysXVehicle>(*this, std::move(gVehicle), util::shared_handle_cast<PhysXRigidBody, ICollisionObject>(rigidBody), std::move(sceneQueryData), steerVsForwardSpeedTable, vhcDesc);
	AddVehicle(*vhc);
	vhc->Spawn();
	vhc->SetRestState();
...
#else
util::TSharedHandle<pragma::physics::IVehicle> pragma::physics::PhysXEnvironment::CreateVehicle(const VehicleCreateInfo &vhcDesc) { return util::TSharedHandle<pragma::physics::IVehicle> {}; }
#endif
