...
namespace pragma::physics {
	...
	class PhysXConstraint : virtual public IConstraint {
	  public:
		enum class StateFlags : uint32_t { None = 0u, Enabled = 1u, Broken = Enabled << 1u };
		friend IEnvironment;
	...
	class PhysXFixedConstraint : public IFixedConstraint, public PhysXConstraint {
	  public:
		friend IEnvironment;
	  protected:
	...
	class PhysXBallSocketConstraint : public IBallSocketConstraint, public PhysXConstraint {
	  public:
		friend IEnvironment;
	  protected:
	...
	class PhysXHingeConstraint : public IHingeConstraint, public PhysXConstraint {
	  public:
		friend IEnvironment;
	...
	class PhysXSliderConstraint : public ISliderConstraint, public PhysXConstraint {
	  public:
		friend IEnvironment;
	...
	class PhysXConeTwistConstraint : public IConeTwistConstraint, public PhysXConstraint {
	  public:
		friend IEnvironment;
	...
	class PhysXDoFConstraint : public IDoFConstraint, public PhysXConstraint {
	  public:
		friend IEnvironment;
	...
	class PhysXDoFSpringConstraint : public IDoFSpringConstraint, public PhysXConstraint {
	  public:
		friend IEnvironment;
